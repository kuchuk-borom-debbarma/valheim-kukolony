...
if [ "${BENCHMARK_SCREENSHOTS:-true}" = "true" ]; then
  expected='colony-villager.png colony-screen-home.png colony-screen-gallery.png colony-screen-paged.png colony-screen-picker.png colony-screen-structures.png colony-screen-structure.png colony-screen-register-nearby.png colony-screen-settings.png'
