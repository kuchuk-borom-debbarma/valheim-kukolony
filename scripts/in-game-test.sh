...
if [ "${BENCHMARK_SCREENSHOTS:-true}" = "true" ]; then
  expected='colony-panel.png colony-structures.png colony-members.png colony-members-page-2.png colony-member-detail.png colony-member-remove-confirm.png colony-outfits.png colony-outfit-card.png colony-jobs.png colony-job-config.png colony-structure-picker.png colony-preset-application.png colony-picker.png'
